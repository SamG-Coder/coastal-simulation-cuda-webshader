...
import {createShading} from './shading.js?v=1.5.0';
import {buildWorld} from './world.js?v=1.5.0';
import {ShoreCamera,VIEWS} from './camera.js?v=1.5.0';
import {isInterfaceEvent} from './navigation.js?v=1.5.0';
import {FrameProfile} from './performance.js?v=1.5.0';
import {registerAgentTools} from './agent-tools.js?v=1.5.0';
import {ResidentCoast} from './resident-coast.js?v=1.5.0';
import {GpuSpray} from './gpu-spray.js?v=1.5.0';
import {makeGpuNoise} from './gpu-interop.js?v=1.5.0';
